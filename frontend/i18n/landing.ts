  ...
  projects: [
    {
      ...
      description:
        "A CRM built for SMBs who've outgrown spreadsheets but aren't ready for enterprise software. React frontend, Supabase and Stripe underneath. Built and used alongside real customers, not designed in a vacuum.",
    },
  ],
